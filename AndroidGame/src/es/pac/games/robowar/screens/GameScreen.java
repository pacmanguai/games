...
import es.pac.games.framework.Animation;
...
import es.pac.games.robowar.RobowarGame;
import es.pac.games.robowar.character.Enemy;
import es.pac.games.robowar.character.Heliboy;
import es.pac.games.robowar.character.Heliboy2;
import es.pac.games.robowar.character.Heliboy3;
import es.pac.games.robowar.character.Robot;
import es.pac.games.robowar.misc.Projectile;
import es.pac.games.robowar.misc.Tile;
...
public class GameScreen extends Screen {
	...
	private void loadMap() {
		...
		Scanner scanner = new Scanner(RobowarGame.map);
	...
	private void updateEnemies() {
		// If the number of enemies is not maximun
	...
	private Enemy getRandomEnemy() {
		...
		switch (type) {
		case 1:
			randomEnemy = new Heliboy(centerX, centerY);
			break;
		case 2:
			randomEnemy = new Heliboy2(centerX, centerY);
			break;
		case 3:
			randomEnemy = new Heliboy3(centerX, centerY);
			break;
		default:
			break;
	...
	private int getRandomValue(final int max) {
	...
	private void paintEnemies(Graphics g) {
		...
		for (Enemy enemy:enemies) {
			g.drawImage(hanim.getImage(), enemy.getCenterX() - 48,
					enemy.getCenterY() - 48);			
		}
